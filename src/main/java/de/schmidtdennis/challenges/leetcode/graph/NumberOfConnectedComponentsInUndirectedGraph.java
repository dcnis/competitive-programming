...
public class NumberOfConnectedComponentsInUndirectedGraph {
    ...
    NumberOfConnectedComponentsInUndirectedGraph(int V) {
        this.V = V;
        // define the size of de.schmidtdennis.challenges.leetcode.array as
        // number of vertices
    ...
    // Adds an edge to an undirected de.schmidtdennis.challenges.leetcode.graph
    void addEdge(int src, int dest) {
        // Add an edge from src to dest.
        adjListArray.get(src).add(dest);

        // Since de.schmidtdennis.challenges.leetcode.graph is undirected, add an edge from dest
        // to src also
    ...
    public static void main(String[] args) {
        // Create a de.schmidtdennis.challenges.leetcode.graph given in the above diagram
